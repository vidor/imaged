<?php
/*
Template Name: Galleries List by Category
*/
?>
...
<?php get_header(); ?>
		...
		<div id="portfolio-grid">
				 ...
				 <?php 	$cats_include = get_post_meta( $post->ID, 'si_gallery_categories', false); 
					$the_query = new WP_Query( array ('post_type' => 'gallery','posts_per_page' => -1,
						"tax_query" => array(
							array(
