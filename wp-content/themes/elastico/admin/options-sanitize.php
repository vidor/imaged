...
/*
 * Override default filter for 'textarea' sanitization and $allowedposttags + script.
 */
add_action('admin_init','options_change_text_area_sanitization', 100);
 
function options_change_text_area_sanitization() {
