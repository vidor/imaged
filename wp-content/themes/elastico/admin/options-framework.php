...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', 'si_theme'), __('Theme Options', 'si_theme'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
if ( !function_exists( 'optionsframework_page' ) ) {
	function optionsframework_page() {
	 		settings_errors();
?>
    <div id="optionsframework-wrap" class="si_optionswrap">
   
		<h2><?php _e('Theme Options', 'si_theme');?></h2>
		
		<div class="si_optionscontainer">
			...
			<div id="optionsframework">
				<form action="options.php" method="post">
					...
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'si_theme' ); ?>" />
						 <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'si_theme' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'si_theme' ) ); ?>' );" />
						 <div class="clear"></div>
				</div>
				</form>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'si_theme' ), 'updated fade' );
	 ...
	 */
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'si_theme' ), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options','si_theme' ),
