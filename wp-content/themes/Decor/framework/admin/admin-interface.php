...
function optionsframework_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "colorpicker":
			...
			$output .= '<input type="text" id="'.$value['id'].'" name="'.$value['id'].'" value="'.$val.'" class="color_picker"/><div id="picker"></div>';
		...
		case "custom_footer":
			...
			$output.= '<option value="1">one column</option>';	
			$output.= '<option value="2">one half, one half</option>';	
			$output.= '<option value="3">one third, one third, one third</option>';	
			$output.= '<option value="4">one third, two third</option>';	
			$output.= '<option value="5">two third, one third</option>';
			//$output.= '<option value="6">one fourth, one fourth, one fourth, one fourth</option>';	
			//$output.= '<option value="7">two fourth, one fourth, one fourth</option>';	
			//$output.= '<option value="8">one fourth, two fourth, one fourth</option>';	
			//$output.= '<option value="9">one fourth, one fourth, two fourth</option>';	
			//$output.= '<option value="10">three fourth, one fourth</option>';
			//$output.= '<option value="11">one fourth, three fourth</option>';
