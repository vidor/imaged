...
<?php if(get_meta_option('pf_video_type')==1) :?>
	...
	<iframe src="http://player.vimeo.com/video/<?php echo get_meta_option('pf_video_id'); ?>?title=0&amp;byline=0&amp;portrait=0"  frameborder="0" width="640" height="360" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>


<?php elseif(get_meta_option('pf_video_type')==2): ?>	

	<iframe class="video" src="http://www.youtube.com/embed/<?php echo get_meta_option('pf_video_id'); ?>" frameborder="0" width="640" height="360" allowfullscreen wmode="opaque"></iframe>
...
<?php else: ?>
	...
	<video id="example_video_<?php echo get_the_id(); ?>" class="video-js vjs-default-skin" controls preload="none" width="640" height="360"
